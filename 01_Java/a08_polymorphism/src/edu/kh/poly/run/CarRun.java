...
public class CarRun {
	public static void main(String[] args) {
		...
		// 다형성 업캐스팅
		// - 부모 타입 참조변수로 자식 타입의 객체를 참조하는것
		// - 참조하는 자식객체 중 부모 부분만 참조
		// 1. 다형성과 객체배열
