...
public class PolyService {
	...
	public void printCar() {
		for (int i = 0; i < arr.length; i++) {
			...
			// 정적 바인딩
			// - 프로그램 실행 전 (컴파일 단계) 메서드 호출부와 메서드 코드를 묶는것
			// -> 참조 변수의 자료형을 토대로 묶임
		...
		// 동적 바인딩은 컴파일러로 검출이 안되기 때문에 실행 결과가 예상과 다르면 모두 개발자의 실수가 되버림
		// -> 다형성이 적용된 코드를 이용할 땐 동적 바인딩을 예상하면서 코드를 작성하자
	}
}
