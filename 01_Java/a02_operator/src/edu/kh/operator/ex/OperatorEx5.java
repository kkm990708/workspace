...
public class OperatorEx5 {
	public static void main(String[] args) {
		...
		System.out.println("num3는 1부터 100 사이의 정수인가? " + result3);
		
		//------------------------------------------------------------
		
		// OR 연산자 (||) 
		// 둘다 false 이면 false 아니면 true
		int num4 = 20;
		boolean result4 = (num4 > 10) || (num4 % 2 == 1) ;
		System.out.println("num4 는 10을 초과하거나 홀수인가? " + result4);
		...
		System.out.println("num7은 1부터 50사이의 정수이면서 5의 배수가 아닌 수? " + result7);
