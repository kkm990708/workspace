...
<head>
  ...
  <title>pizza_ order</title>

  <%-- resources 폴더 내용은 절대 경로를 사용하는 것이 좋다
  [절대 경로 기준 == webapp == /]
   --%>
...
<body>
  <main>
    <%-- /pizza/order 라는 같은 주소 요청 처리되는 Servlet이 존재하지만
    ...
    <div class ="row  ">
      ...
      <select name="pizza">
        ...
        <option>콤비네이션 피자-8000</option>
        <option>쉬림프피자-15000</option>
        <option>더블 포테이토 피자-14000</option>
        <option>하와이안피자-12000</option>
      </select>

      <div class="row">
        <label for="">사이즈 : </label>
        R <input type="radio" name="size" value="R">
        L(+4000) <input type="radio" name="size" value="R">
      </div>
        <label for="">수량</label>
