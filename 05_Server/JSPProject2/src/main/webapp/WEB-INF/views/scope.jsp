...
<body>
  ...
  <pre>
    ...
    session : 사바에 접속한 클라이언트를 나타내거나 , 관련 정보를 get,set 할 수 있는 객체
    ...
    <h4>4. aplication (ServletContext)</h4>
    - 하나의 웹 애플리케이션 마다 1개만 생성되는 객체
      (Server를 키면 1개만 생성되는 객체)

    - application 객체는 어디서든 사용가능
  ...
  <h2>\${str} : 4종류의 scope 객체를 좁은 순서대로 탐색해서
