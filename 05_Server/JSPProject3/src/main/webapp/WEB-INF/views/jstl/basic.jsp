...
<body>
  ...
  <pre>
    - 변수 선언(속성 추가 == setAttribute를 위한 태그)
    ...
    - 작성 가능한 속성
      ...
      3) scope : 범위지정(page, request, session, application)
                 (기본값은 page)
  ...
  <h5>제거후 test1 : ${pageScope.test1} </h5>
