...
ADD CONSTRAINT DAPT_COPY_PK PRIMARY KEY(DEPT_ID);
...
CONSTRAINT DEPT_COPY_TITLE_U UNIQUE(DEPT_TITLE);
...
ALTER TABLE DEPT_COPY
DROP CONSTRAINT SYS_C0014121;


-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY MODIFY
DEPT_ID CONSTRAINT SYS_C0014071 NULL; 


ALTER TABLE DEPT_COPY MODIFY
LOCATION_ID CONSTRAINT SYS_C0014072 NULL; 
...
CREATE TABLE "MEMBER"(
	...
	MEMBER_TEL CHAR(15) NOT NULL,
	MEMBER_ADDRESS VARCHAR2(300),
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MEMBER_DEL_FL CHAR(1) DEFAULT 'N' NOT NULL
	
	,CONSTRAINT NO_PK PRIMARY KEY (MEMBER_NO)
	,CONSTRAINT DEL_FL_CHECK CHECK (MEMBER_DEL_FL IN ('Y','N'))
);
DROP TABLE "MEMBER" ;
...
CREATE TABLE BOARD (
	...
	CONSTRAINT BOARD_DEL_FL_CK CHECK (BOARD_DEL_FL IN ('Y','N')),
	CONSTRAINT MEMBER_NO_FK FOREIGN KEY (MEMBER_NO) REFERENCES "MEMBER"
...
CREATE TABLE "COMMENT" (
	...
	CONSTRAINT COMMENT_DEL_FL CHECK(COMMENT_DEL_FL IN ('Y','N')),
	CONSTRAINT BOARD_NO_FK FOREIGN KEY (BOARD_NO) REFERENCES BOARD,
	CONSTRAINT CO_MEMBER_NO_FK FOREIGN KEY (MEMBER_NO) REFERENCES "MEMBER"
