...
// 1) appendChild("내용"또는 노드) : 마지막 자식 노드 추가
// list[11]의 마지막 자식으로 "ZZZ"추가
list[11].appendChild(document.createTextNode("ZZZ"));

// document.createTextNode("ZZZ") : 텍스트 노드(글자 )생성
// 2) appendChild("내용"또는 노드) : 마지막 자식 노드 추가
// list[11]의 마지막 자식으로 "ZZZ"추가
list[11].appendChild(document.createTextNode("ZZZ"));
...
// 2) append("내용" 또는 노드 요소
//    마지막 자식 내용/노드/요소로 추가)
//    + 매개변수로 여러 값을 작성해 한번에 추가 가능

// list[11].append("1234,5678,90,as");

// 3) prepend("내용" 또는 노드 요소
// 첫번째 자식 내용/노드/요소를 추가)
// + 매개변수로 여러 값을 작성해 한번에 추가 가능

list[11].prepend("가가가가", "나나나", "다다다");
...
btn2.addEventListener("click", () => {
  ...
  // #test2룰 기준으로 body 태그의 첫 번째 자식 요소 선택
