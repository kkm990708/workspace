...
// increment.addEventListener('click', function() {
  ...
  // #increment 버튼 클릭시 
  // countincrement 함수 코드를 실행

  // increment 버튼 클릭시 countIncrement 함수 코드를 실행
...
/* ** 변수 = 함수명 형식으로 함수를 선언한 경우 ** 
  - 함수를 선언한걸로 인식하는 것이 아닌 
    ...
    해석 순서 1번(함수 위치 인식)을 으로 인식되지 않아
...
arrowList[2].addEventListener("click", () => {
  //다른 함수 호출
  // 매개변수로 a,b 두 값을 전달 받아 곱한 값을 반환하는 익명함수를
  // 전달
