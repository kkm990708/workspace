...
@Component	// bean 등록 (bean == spring container 가 관리하는 객체 )
@Slf4j
...
//	@Scheduled(cron = "0,15,30,45 * * * * *") // 시계 초 단위가 0, 30 인 경우 수행
