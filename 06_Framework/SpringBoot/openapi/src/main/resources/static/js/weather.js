...
// 서비스키
const serviceKey = "gHsraoiBgDTxmQOSmNCfNQw5eUiQMzHanPOgCzd49zTiNkF2exiMsphSXHTgMJhkvndJEh9OCrTOdzwYXEGKJQ==";
const numOfRows = 900;
const pageNo = 1;
const dataType = "JSON";
...
const getUltraSrtPtyState = (code) => {
  ...
  const getUltraSrtNcst = (regionValue) => {
    ...
    /* Ajax로 regionName 지역의 초단기 예보 얻어오기 */
