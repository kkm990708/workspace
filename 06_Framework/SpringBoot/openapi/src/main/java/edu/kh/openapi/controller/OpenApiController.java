...
public class OpenApiController {
	...
	public String ex2( Model model, 
		...
		final String serviceKey = "gHsraoiBgDTxmQOSmNCfNQw5eUiQMzHanPOgCzd49zTiNkF2exiMsphSXHTgMJhkvndJEh9OCrTOdzwYXEGKJQ%3D%3D";
		
		// 지역 좌표가 저장된 map
		final Map<String, Object> coordinateList = new HashMap<>();
	   ...
	   // 현재 시간 얻어와 baseDate, baseTime가공
	      ...
	      String[] coordinate = ((String) coordinateList.get(regionName)).split("/");
	    ...
	    // JSONobject : spring Boot 에서 제공하는 JSON 다루기 용도의 객체
	...
	private final String serviceKey = "gHsraoiBgDTxmQOSmNCfNQw5eUiQMzHanPOgCzd49zTiNkF2exiMsphSXHTgMJhkvndJEh9OCrTOdzwYXEGKJQ%3D%3D";
	...
	*/
	...
	@GetMapping("air")
	public String airPollution(@RequestParam("location") String location, Model model) throws IOException{
	...
	System.out.println(sb.toString());
	model.addAttribute("air",sb.toString());
	model.addAttribute("urlBuilder",urlBuilder.toString());
